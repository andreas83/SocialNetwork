...
class DataController extends BaseController
{
     ...
     * @param type $request
     */
    public function stream($request=false)
    {
     ...
     * @param type $request
     */
    public function get_permalink($request)
    {
        $data = new Content;
    ...
    public static function replaceVideo($input, $dimension = false)
    {
